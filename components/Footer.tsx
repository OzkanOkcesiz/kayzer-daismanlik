        ...
        <div className="flex flex-col md:flex-row flex-wrap items-start justify-between gap-8">
          ...
          <div className="flex-shrink-0 md:max-w-xl">
            ...
            <p className="mt-4 text-brown-200">
              Profesyonel danışmanlık hizmetleriyle işletmenizi bir adım öne
              taşıyoruz. Stratejik çözümler ve uzman kadromuzla yanınızdayız.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-brown-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-brown-200 text-sm">
              © {new Date().getFullYear()} Kayzer Danışmanlık. Tüm hakları
              saklıdır.
            </p>
